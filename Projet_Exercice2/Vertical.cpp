...

{
	...
	// KM : Excellent commentaire et très bien d'avoir pensé à citer la source !!
	if(nb5 >= 10000 && nb5 <= 99999) //Opérateur logique && retourne true si les deux conditions sont respectées. Notions prise de: https://www.w3schools.com/cpp/cpp_operators_logical.asp
	{
		...
		// KM : Excellent commentaire qui explique bien le calcul
...
//Plan de test
// KM : Plan de tests très détaillé : Excellent !
	/*
